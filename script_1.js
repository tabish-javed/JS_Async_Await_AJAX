...
//         getJSON(`https://restcountries.com/v3.1/name/turkey?fullText=true`),
//     ]);
...
//     timeout(0.7)
// ]).then(response => console.log(response[0])).catch(error => console.error(error));


async function racingPromise () {
    try {
